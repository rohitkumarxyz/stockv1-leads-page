      ...
      <div className="pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <p className="text-gray-500">Last updated: July 02, 2025</p>
          </motion.div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 space-y-8">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TradeStock, 1016, Gali No. 2, Bhoor Colony, Sector 29, Faridabad, Haryana, 121008.</li>
                  ...
                  <li><strong>Website</strong> refers to TradeStock, accessible from the Company's website.</li>
              ...
              <section>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="font-semibold text-gray-800 mb-2">Necessary / Essential Cookies</p>
                  <p className="text-sm text-gray-600 mb-1"><strong>Type:</strong> Session Cookies</p>
                  <p className="text-sm text-gray-600 mb-1"><strong>Administered by:</strong> Us</p>
                  <p className="text-sm text-gray-700">These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                </div>

                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="font-semibold text-gray-800 mb-2">Cookies Policy / Notice Acceptance Cookies</p>
                  <p className="text-sm text-gray-600 mb-1"><strong>Type:</strong> Persistent Cookies</p>
                  <p className="text-sm text-gray-600 mb-1"><strong>Administered by:</strong> Us</p>
                  <p className="text-sm text-gray-700">These Cookies identify if users have accepted the use of cookies on the Website.</p>
                </div>

                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <p className="font-semibold text-gray-800 mb-2">Functionality Cookies</p>
                  <p className="text-sm text-gray-600 mb-1"><strong>Type:</strong> Persistent Cookies</p>
                  <p className="text-sm text-gray-600 mb-1"><strong>Administered by:</strong> Us</p>
                  <p className="text-sm text-gray-700">These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                </div>
